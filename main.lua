	...
	if not obj:IsDescendantOf(Players) and flagged == false then
		...
		elseif obj:IsA("MeshPart") then
			...
			if Settings.Meshes.Destroy then
				RunService.Heartbeat:Wait()
				obj:Destroy()
			elseif Settings.Meshes["Remove Texture"] and obj.Material ~= Enum.Material.Glass then
		...
		elseif obj:IsA("Explosion") and Settings.Main["No Explosions"] then
			obj.Visible = false
		elseif obj:IsA("BasePart") and Settings.Main["Low Quality Parts"] and obj.Material ~= Enum.Material.Glass then
